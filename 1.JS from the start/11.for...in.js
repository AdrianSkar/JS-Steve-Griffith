...
for (const prop in monsters) {
  ...
  //When using console.log you don't need extra spaces as they will be added automatically
}
...
for (const prop2 in pets) {
  ...
  //Prop becomes the counter and pets is the array we are looping trough
